...
const KNOWLEDGE_BASE: Record<string, string> = {
  ...
  "background": "Grant has 10+ years of experience in sales engineering, technical consulting, and enterprise software. He’s held six progressive roles at Conga, advancing from Sr. BDR to Principal Sales Engineer. At Conga, he supported strategic sales efforts, built custom demos, and helped close over $41M in enterprise business. Prior to Conga, he held sales and leadership roles at DNN Corp and Canto. See his full [resume](https://grantglazer.com/resume).",
  "tech": "Grant is skilled in Salesforce, AWS, and Microsoft Dynamics. He also built and maintains his own website using Vercel’s V0 and GPT-4o. You can explore more about his tools and projects on his [blog](https://grantglazer.com/blog).",
  ...
  "career history": "Grant has worked across a range of enterprise roles—from SDR to Principal Sales Engineer—primarily at Conga, with prior experience at DNN Corp and Canto. He’s driven success in technical sales, process improvement, and solution engineering. See full [resume](https://grantglazer.com/resume).",
  "clients": "Grant has supported digital transformation initiatives at multiple Fortune 100 companies, delivering technical solutions at scale. Explore more on his [expertise page](https://grantglazer.com/my-expertise).",
